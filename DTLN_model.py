...
if __name__ == '__main__':
    ...
    parser.add_argument("--wav_dir",
                        type=str,
                        help="wav directory",
                        default=os.path.dirname(__file__) + "/original_audio/")
    
    parser.add_argument("--out_dir",
                        type=str,
                        help="result directory",
                        default=os.path.dirname(__file__) + "/enhanced_audio/")
